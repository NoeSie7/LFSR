...
//        final char SR[] = { 0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB,
         final char SR[] = { 0x63, 0x7C, 0x77, 0x7B, 0xF2, 0x6B, 0x6F, 0xC5, 0x30, 0x01, 0x67, 0x2B, 0xFE, 0xD7, 0xAB,
                ...
                0x54, 0xBB, 0x16 };
        final char SQ[] = {  };

        System.out.println(" \n SBOX -> SR \n\n");
        for (int i = 0; i < SR.length; ++i) {
            System.out.println("POS: [" + i + "]" + SR[i]);
        }

        System.out.println(" \n\n SBOX -> SQ \n");
        for (int i = 0; i < SQ.length; ++i) {
            System.out.println("POS: [" + i + "]" + SQ[i]);
        }
    }
